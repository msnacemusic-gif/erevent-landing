...
(function () {
  ...
  /* Реальные проекты с главной страницы. cat — группа для фильтра;
     фото ищется по номеру в media/case-NN.jpg, как и на главной. */
  var WORKS = [
    ...
    { n: '03', cat: 'decor', title: 'МТФ «Путешествуй»', year: '2024, 2025, 2026', client: 'Фонд Росконгресс', tasks: 'Застройка стендов, шатры, мебель и оборудование на стенды, изготовление арт-объекта, застройка VIP-зоны', place: 'ВДНХ' },
    ...
    { n: '08', cat: 'decor', title: 'Запуск спорткомплекса Padel Ball', year: '', client: 'Padel Ball', tasks: 'Дизайн, строительные работы, брендирование, навигация, мебель и оборудование', place: 'Химки, Gopark' },
    { n: '09', cat: 'decor', title: 'Оформление входной группы БЦ', year: '', client: 'БЦ «Парк Победы»', tasks: 'Дизайн, изготовление и монтаж декораций входной группы', place: 'БЦ «Парк Победы»' },
  ...
  /* Группы заданы по реальным задачам проектов. Пустых фильтров не держим:
     кнопка, которая ничего не показывает, выглядит поломкой. */
  var FILTERS = [
    { id: 'all', label: 'Все' },
    { id: 'events', label: 'Мероприятия и фестивали' },
    { id: 'decor', label: 'Оформление и застройка' }
  ];
  ...
  function render() {
    ...
    grid.innerHTML = list.length
      ...
      : '<p class="art-grid__empty">В этой группе пока нет проектов.</p>';
