(function () {
  ...
  /* Куда уходит заявка: приёмник на своём хостинге. Он записывает заявку
     в базу на сервере в России и только потом шлёт уведомление в Telegram
     и письмо. Адрес относительный — на страницах направлений к нему
     подставляется «../» (см. ниже). */
